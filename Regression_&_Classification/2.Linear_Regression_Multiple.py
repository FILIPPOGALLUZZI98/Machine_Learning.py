...
# Funzione che definisce il modello (e quindi la previsione)
def model(x, w, b): 
    p = np.dot(x, w) + b     
...
initial_w = np.zeros_like(w_init); initial_b = 0.; iterations = 10000; alpha = 5.0e-11
# Run gradient descent 
w_final, b_final = gradient_descent(X_train, y_train, initial_w, initial_b, cost_function,
                                    gradient, alpha, iterations)
